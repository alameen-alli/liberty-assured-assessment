...
const SideBar = () => {
  return (
    // nav container
    <nav className="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl hidden flex-wrap items-center justify-between text-white relative md:w-[18rem] z-10 py-[3.88rem] px-8">
      {/* nav content */}
        ...
        <div>
          ...
          <ul className="md:flex-col md:min-w-full flex flex-col list-none">
            <li className="items-center">
              <a
                className="flex items-center  py-3 pl-6 rounded-lg"
